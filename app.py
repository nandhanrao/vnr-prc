...
class LitGradio(ServeGradio):
    ...
    examples = [
        [os.path.join(os.path.dirname(__file__), "assets", "fruits.jpg"), None],
        [os.path.join(os.path.dirname(__file__), "assets", "pasta.jpeg"), None],
        [os.path.join(os.path.dirname(__file__), "assets", "pizza.jpeg"), None],
        [os.path.join(os.path.dirname(__file__), "assets", "salad.jpeg"), None],
        [os.path.join(os.path.dirname(__file__), "assets", "waffle.jpeg"), None],
    ]

    def __init__(self):
        super().__init__()
        self.ready = False
        self.model = self.build_model()  # Initialize model here
